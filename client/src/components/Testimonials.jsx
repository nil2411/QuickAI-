const Testimonials = () => {
    ...
    return (
        <div className='px-4 py-16 sm:px-8 sm:py-24 lg:px-20 xl:px-32'>
            ...
            <div className='mx-auto mt-10 grid max-w-6xl grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3'>
                {dummyTestimonialData.map((testimonial, index) => (
                    <div key={index} className='w-full cursor-pointer rounded-lg border border-gray-100 bg-[#FDFDFE] p-6 shadow-lg transition duration-300 hover:-translate-y-1 sm:p-8'>
